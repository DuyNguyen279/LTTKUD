...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def loadData(self):
        model.setRowCount(0)
        data = studentDAO.StudentDAO().selectAll()
        department = set()
        for student in data:
    ...
    def openAddStudentForm(self):
        from addNewStudentForm import AddNewStudentForm
